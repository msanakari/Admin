...
import { BuySellOffcanvasComponent } from '../../shared/buy-sell-offcanvas/buy-sell-offcanvas.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, MatPaginatorModule, MatSelectModule, MatFormFieldModule, BuySellOffcanvasComponent, DeletePopupComponent],
